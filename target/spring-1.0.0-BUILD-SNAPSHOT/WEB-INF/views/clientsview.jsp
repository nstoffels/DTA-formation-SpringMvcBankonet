...
<body>
	...
	<h2><spring:message code="affichage"/></h2>
	...
	<form:form modelAttribute="client" action="/BankonetSpringMVC/saveClient">
		<table>
			...
			<tr>
				<td><form:label path="prenom"><spring:message code="prenom"/> :</form:label></td>
				<td><form:input path="prenom" /></td>
				<%-- Show errors for prenom field --%>
				<td><form:errors path="prenom" /></td>
			</tr>
			<tr>
				<td><form:label path="nom"><spring:message code="nom"/>:</form:label></td>
				<td><form:input path="nom" /></td>
				<%-- Show errors for nom field --%>
				<td><form:errors path="nom" /></td>
			</tr>
			<tr>
				<td><form:label path="login"><spring:message code="login"/> :</form:label></td>
				<td><form:input path="login" /></td>
				<%-- Show errors for login field --%>
				<td><form:errors path="login" /></td>
			</tr>
			<tr>
				<td><form:label path="motDePasse"><spring:message code="motDePasse"/> :</form:label></td>
				<td><form:input path="motDePasse" /></td>
				<%-- Show errors for motDePasse field --%>
				<td><form:errors path="motDePasse" /></td>
			</tr>
		</table>
		<button value="submit"> <spring:message code="valider"/> </button>
	</form:form>
